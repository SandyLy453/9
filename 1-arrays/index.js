...
var bakingRecipes = new Array("brownies", "cookies", "cakes", "tart");
...
var schedule = [
    [ "COMP 1170", "Fundamentals Fonted web Tech", "3.0"],
    [ "MDIA 1055", "Vector Graphic", "3.0"],
    [ "MDIA 1106", "Design", "3.0"],
    [ "MDIA 1162", "Basic System Operations and Prog", "3.0"],
]

console.table(schedule);

console.log(`I am taking ` + schedule[2][0] + `, ` + schedule[2][1] + ` that worth ` + schedule[2][2] + ` credits` );
